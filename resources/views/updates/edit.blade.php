...
@section('title', 'Activisme_BE - '. $update->title)
        ...
        <div class="col-md-offset-1 col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('updates.update', $update) }}" class="form-horizontal">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{ $update->title }}" name="title" placeholder="Update titel">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="status" class="form-control">
                                    ...
                                    <option value="public" @if ($update->status == 'public') selected @endif>Publiceer</option>
                                    <option value="draft" @if ($update->status == 'draft') selected @endif>Klad</option>
                                </select>
                            </div>
                        </div>
